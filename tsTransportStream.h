...
public:
  ...
  bool     getTransportPriority() const { return m_T; }
  ...
  ePID     getPIDType() const { return static_cast<ePID>(m_PID); }




public:
//bool hasAdaptation = packetHeader.hasAdaptationField();
//bool hasPayload = packetHeader.hasPayload();
};
//=============================================================================================================================================================================
